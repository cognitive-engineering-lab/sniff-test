...
pub struct ExternArtifactInput {
    pub name: String,
    pub artifact_id: RustcArtifactId,
}

/// A structured reason why an artifact could not join the composed graph.
#[derive(Debug)]
pub enum GraphLoadFailure {
    Missing {
...
pub struct ArtifactAnalysisGraph {
...
impl ArtifactAnalysisGraph {
    ...
    pub fn artifacts(&self) -> impl Iterator<Item = &ArtifactAnalysisCache> {
        self.artifacts.iter()
    }

    #[must_use]
    pub fn artifact(&self, artifact_id: &RustcArtifactId) -> Option<&ArtifactAnalysisCache> {
    ...
    #[must_use]
    pub fn artifact_info_by_stable_crate_id(&self, stable_crate_id: u64) -> Option<&ArtifactInfo> {
    ...
    pub fn direct_dependency_ids(&self) -> impl Iterator<Item = RustcArtifactId> + '_ {
    ...
    pub fn failures(&self) -> impl Iterator<Item = &GraphLoadFailure> {
        self.failures.iter()
    }
