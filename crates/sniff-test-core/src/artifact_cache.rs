...
pub struct ArtifactAnalysisCache {
    pub format_version: u32,
    pub tool_version: String,
    pub rustc_version: String,
    pub artifact: ArtifactInfo,
    pub dependencies: Vec<RustcArtifactId>,
...
impl RustcArtifactId {
    #[must_use]
    pub fn new(stable_crate_id: u64, svh: impl Into<String>) -> Self {
        Self {
            stable_crate_id,
            svh: svh.into(),
        }
...
#[must_use]
pub fn artifact_cache_path(cache_dir: &Path, artifact_id: &RustcArtifactId) -> PathBuf {
    cache_dir
        .join("artifacts")
