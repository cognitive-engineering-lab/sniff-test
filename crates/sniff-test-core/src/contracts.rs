...
impl ContractDocOverrides {
    ...
    #[must_use]
    pub fn markdown_for_candidates(&self, candidates: &[String]) -> Option<&str> {
        self.markdown_for_pattern(self.best_pattern_for_candidates(candidates)?)
    }

    #[must_use]
    pub fn best_pattern_for_candidates(&self, candidates: &[String]) -> Option<&str> {
        self.patterns
...
pub struct ContractDocSummary {
    pub has_docs: bool,
    pub requirements: Vec<ContractRequirement>,
    pub ambiguous_requirements: Vec<AmbiguousContractRequirements>,
}
...
#[must_use]
pub fn contract_doc_summary_from_attrs(
    tcx: TyCtxt<'_>,
    def_id: DefId,
    obligation: &str,
) -> ContractDocSummary {
...
#[must_use]
pub fn contract_doc_summary_from_markdown(markdown: &str, obligation: &str) -> ContractDocSummary {
...
pub fn markdown_list_item_body(line: &str) -> Option<&str> {
