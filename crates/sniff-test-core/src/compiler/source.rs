...
/// stale marker facts.
pub fn verify_cached_marker_sources(
    tcx: TyCtxt<'_>,
    ir: &ArtifactFacts,
...
pub struct CachedSourceMap<'map> {
...
pub fn source_filename(file: &SourceFile) -> String {
...
pub fn stable_source_file_id(file: &SourceFile) -> SourceFileId {
