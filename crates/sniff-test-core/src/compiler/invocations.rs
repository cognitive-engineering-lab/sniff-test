...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UnresolvedCallTargetReason {
    FunctionPointer,
    DynamicDispatch,
    GenericDispatch,
    UnavailableBody,
...
impl Invocation {
    ...
    #[must_use]
    pub fn raw_calls(&self) -> &[CallId] {
        &self.raw_calls
    }

    pub fn declaration_targets(&self) -> impl Iterator<Item = FunctionId> + '_ {
        self.declarations.iter().copied()
    }

    pub fn function_targets(&self) -> impl Iterator<Item = FunctionId> + '_ {
    ...
    #[must_use]
    pub fn macro_provenance(&self) -> &[MacroExpansionFact] {
    ...
    #[must_use]
    pub fn is_suppressed_by_compiler_context(&self) -> bool {
    ...
    #[must_use]
    pub fn resolution(&self) -> InvocationResolution {
...
impl InvocationGraph {
    pub fn from_artifact(artifact: &ArtifactFacts) -> Result<Self, InvocationGraphError> {
    ...
    pub fn set_dependencies(&mut self, direct: &BTreeMap<u64, BTreeSet<u64>>) {
    ...
    #[must_use]
    pub fn is_dependency(&self, owner: u64, dependency: u64) -> bool {
    ...
    #[must_use]
    pub fn function(&self, stable: StableFunctionId) -> Option<FunctionId> {
        stable
    ...
    #[must_use]
    pub fn stable_function(&self, function: FunctionId) -> StableFunctionId {
    ...
    #[must_use]
    pub fn contract_targets(&self, contract_owner: StableFunctionId) -> BTreeSet<FunctionId> {
    ...
    #[must_use]
    pub fn contract_declaration(&self, function: FunctionId) -> Option<StableFunctionId> {
    ...
    #[must_use]
    pub fn invocation_aliases(&self, invocation: InvocationId) -> Vec<InvocationId> {
    ...
    #[must_use]
    pub fn invocation(&self, invocation: InvocationId) -> &Invocation {
        &self.invocations[invocation.index()]
    }

    #[must_use]
    pub fn invocations(&self) -> impl ExactSizeIterator<Item = &Invocation> {
        self.invocations.iter()
    }

    /// Returns the source call projection that reaches this concrete target.
    #[must_use]
    pub fn source_edge(&self, invocation: InvocationId, target: FunctionId) -> Option<&CallFact> {
    ...
    #[must_use]
    pub fn source_edges(&self, invocation: InvocationId) -> &[CallFact] {
        &self.invocation(invocation).raw_edges
    }

    pub fn raw_calls_reaching(
        &self,
        invocation: InvocationId,
        target: FunctionId,
    ...
    #[must_use]
    pub fn transparent_source(&self, edge: TransparentBodyEdgeId) -> &CallFact {
        &self.transparent_source[edge.index()]
    }

    #[must_use]
    pub fn invocation_for_raw_call(
        &self,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct InvocationGraphError {
    message: String,
}
