...
pub(crate) const CACHE_FORMAT_VERSION: u32 = 29;
pub(crate) const CACHE_DIR_NAME: &str = "sniff-test-cache";
pub(crate) const CACHE_VERSION_DIR: &str = "v29";
...
mod tests {
    ...
    fn current_format_round_trip_preserves_artifact_identity_scope_dependencies_and_facts() {
        ...
        assert_eq!(json["format-version"], 29);
    ...
    fn cache_paths_use_the_current_version_directory() {
        ...
        assert_eq!(
            ...
            "/target/plugin-nightly/sniff-test-cache/v29"
        );
        assert_eq!(
            artifact_cache_path(&root, &identity).to_string_lossy(),
            "/target/plugin-nightly/sniff-test-cache/v29/artifacts/0000000000000001-0123456789abcdef0123456789abcdef.json"
        );
    }
}
