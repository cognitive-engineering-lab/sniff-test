...
pub enum PropertyViolation {
    ...
    Unconditional,
    // ConditionallyBad(Vec<Spanned<Requirement>>),
...
pub fn parse_fn_def<P: Property>(
    ...
    simple_parse_fn_def(doc_str, property, AnnotationSource::DocComment)
}
...
pub fn parse_expr<'tcx, P: Property>(
    ...
    let direct_annotation = get_doc_str(call_expr, tcx)
        .and_then(|doc_str| simple_parse_callsite(doc_str, property, AnnotationSource::DocComment));
    ...
    simple_parse_callsite(
        ...
        property,
        AnnotationSource::DocComment,
    )
}

fn simple_parse_callsite<P: Property>(
    doc_str: DocStr,
    property: P,
...
fn simple_parse_fn_def<P: Property>(
    doc_str: DocStr,
    property: P,
    source: AnnotationSource,
) -> Option<DefAnnotation> {
