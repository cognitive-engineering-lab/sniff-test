...
use sniff_test_core::config::{LintLevel, ReportRootSet};
use sniff_test_core::report_roots::MissingReportRoot;
use toml::Spanned;

use super::findings::{DiagnosticMessage, FindingDiagnostic};

pub fn emit_finding_diagnostic(
    tcx: TyCtxt<'_>,
    level: LintLevel,
    lint_code: &str,
...
pub fn emit_footer_note(tcx: TyCtxt<'_>, message: &str) {
...
#[must_use]
pub fn empty_report_roots_diagnostic(
    tcx: TyCtxt<'_>,
    manifest_path: &Path,
...
#[must_use]
pub fn missing_report_root_diagnostic(
    tcx: TyCtxt<'_>,
    manifest_path: &Path,
