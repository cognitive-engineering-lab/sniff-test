...
root is likewise still checked for missing `# Safety` documentation.

Standard-library crates have distinct definition namespaces. To trust their
public `# Safety` surfaces without auditing implementation-internal operations,
contracts, or marker ambiguity, list them explicitly:
